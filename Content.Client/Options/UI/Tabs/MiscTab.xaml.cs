...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        // funky start
        var radioColors = _prototypeManager.EnumeratePrototypes<RadioChannelColorsPrototype>().ToList();
        radioColors.Sort();
        var radioColorEntries = new List<OptionDropDownCVar<string>.ValueOption>();
        foreach (var radioColorPreset in radioColors)
        {
            radioColorEntries.Add(new OptionDropDownCVar<string>.ValueOption(radioColorPreset.ID, Loc.GetString(radioColorPreset.Name)));
        }
        // funky end
        ...
        Control.AddOptionDropDown(RadioChannelColorCvar.ChannelColorPreset, DropDownRadioColors, radioColorEntries); // funky
